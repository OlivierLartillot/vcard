 ...
 */
final class Version20230322174317 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE social (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(60) NOT NULL, default_image VARCHAR(60) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user_social (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, social_id INT NOT NULL, link VARCHAR(255) DEFAULT NULL, published TINYINT(1) DEFAULT NULL, appearance_order SMALLINT DEFAULT NULL, INDEX IDX_1433FABAA76ED395 (user_id), INDEX IDX_1433FABAFFEB5B27 (social_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
